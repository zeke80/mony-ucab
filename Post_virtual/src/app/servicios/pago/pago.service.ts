...
export class PagoService {
  ...
  realizarCobro(cobro: Cobro){
    ...
    console.log(body);
    return this.http.post('http://monyucab.somee.com/api/Transfer/realizarcobro',body, {headers: header});
  }
  ...
  cancelarCobro(IdCobro){
    ...
    return this.http.post('http://monyucab.somee.com/api/Transfer/CancelarCobro',null, options)
  }
  ...
  crearPagoPaypal(){
    ...
    return this.http.post('http://monyucab.somee.com/api/Paypal/CrearPago',body, {headers: header});
  }




  ejecutarPagoPaypal(body){
    let header = new HttpHeaders({'Authorization': 'Bearer ' + localStorage.getItem('token')});
    


    return this.http.post('http://monyucab.somee.com/api/Paypal/PagoExitoso',body, {headers: header});
  }

  cancelarPagoPaypal(body){
    let header = new HttpHeaders({'Authorization': 'Bearer ' + localStorage.getItem('token')});

    return this.http.post('http://monyucab.somee.com/api/Paypal/PagoCancelado',body, {headers: header});
  }
  ...
  ejecutarPagoStripe(body){
    ...
    return this.http.post('http://monyucab.somee.com/api/Stripe/CrearPago',body, {headers: header});
  }
}
